    ...
    <div className={cn("flex h-full flex-col min-h-0", className)}>
      <div className="flex h-14 shrink-0 items-center justify-between gap-4 border-b px-3">
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-semibold text-base leading-none">Inbox</h1>
        </div>
      ...
      <Tabs defaultValue="all" className="shrink-0">
        <TabsList variant="line" className="w-full border-b px-2 **:data-[slot=tabs-trigger]:border-x-0">
