...
export function ChatThread({ contact, messages, onOpenContact, onBack, showBackButton, className }: ChatThreadProps) {
  return (
    <div className={cn("flex h-full flex-col min-h-0", className)}>
      <div className="flex h-14 shrink-0 items-center justify-between gap-4 border-b px-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-muted-foreground text-xs leading-tight">{contact.role}</div>
          </div>
        </div>
    ...
    <div className="flex flex-col gap-4 px-3 pb-2">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1">
          ...
          <Button variant="outline" size="icon" className="size-8" aria-label="AI assist" title="Masbro AI Assist">
            <img src="/rexpro-ai_logo.svg" alt="masbro" className="size-4" />
          </Button>
        </div>
