...
export function BillsPrimaryButtons() {
  const { viewMode, setViewMode, setSelectedBillId } = useBills()
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      setRefreshing(false)
      toast.success('Vendor bills list refreshed!')
    }, 1000)
  }
  ...
  return (
    <div className='flex items-center gap-2'>
      ...
      >
        <Plus size={15} />
        <span className='text-xs'>Enter Vendor Bill</span>
      </Button>
    </div>
  )
}
